...
import { IconBuilding, IconCakeRoll, IconHeart } from "@tabler/icons-react"
  ...
  return (
    <div className="">
      <div className="flex  min-w-0 flex-col gap-4 text-sm leading-loose">
        ...
        <div className="py-4">
          <h1 className="font-heading font-bold text-2xl flex items-center gap-2"> <IconHeart stroke={2}/> Start Your New Life </h1>
          <VenueLister list={[
            {
              id: 1,
              image: "https://www.alsajconventioncenter.com/wp-content/uploads/2023/07/Arena.png",
